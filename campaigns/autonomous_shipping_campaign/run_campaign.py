...
def main():
    ...
    initial_access.phishing_attack("autonomous_shipping_companies_employees.txt", smtp_config)
    ...
    run_tool("autonomous_shipping_technology_and_hijacking_ships_exfiltrator.py")
